...
<head>
  ...
  <meta name="keywords" content="Student, Hire, Junior, Programming, Computer Science" />
  <meta name="description" content="A portal for finding and hiring a student from Brainster Academy">
  <link rel="icon" type="image/x-icon" href="./assets/img/favicon.ico">
  <title>Brainster Labs | <?= $title ?></title>
  <!-- Main stylesheet -->
